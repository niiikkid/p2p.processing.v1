                    ...
                    <ol class="relative border-s border-gray-200 dark:border-gray-700">
                        <li class="mb-8 ms-6">
                            ...
                            <p class="mb-3 text-base font-normal text-gray-500 dark:text-gray-400">
                                Для получения СМС/Push нужно приложение, которое доступно только для Android
                            </p>
                        ...
                        <li class="mb-10 ms-6">
                            ...
                            <h3 class="mb-1.5 text-lg font-semibold leading-none text-gray-900 dark:text-white">
                                2. Запустите приложение и подключите ваше устройство
                            </h3>
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                                Приложение попросит у вас токен для подключения устройства.
                                Создать токен для вашего устройства можно на этой странице.
                                <a :href="route('trader.devices.index')" class="text-blue-500">Перейти</a>
                            </p>
                        </li>
                        ...
                        <li class="ms-6">
                            ...
                            <p class="text-base font-normal text-gray-500 dark:text-gray-400">
                                При получении СМС/Push от банка, мы его получим от Вашего телефона. Главное, чтобы он работал
                                :)
                            </p>
                        </li>
                    </ol>
