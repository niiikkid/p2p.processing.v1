                    ...
                    <div>
                        <div class="mt-6 space-y-6">
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400">
                                <li class="me-2">
                                    <a @click.prevent="tab = 'statistics'; openPage()" href="#" :class="tab === 'statistics' ? 'shadow inline-flex px-4 py-2 text-white bg-blue-600 rounded-lg active' : 'border border-gray-200 inline-flex px-4 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white'" aria-current="page">
                                ...
                                <li class="me-2">
                                    <a @click.prevent="tab = 'payments'; openPage(1)" href="#" :class="tab === 'payments' ? 'shadow inline-flex px-4 py-2 text-white bg-blue-600 rounded-lg active' : 'border border-gray-200 inline-flex px-4 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white'" aria-current="page">
                                        <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                ...
                                <li class="me-2">
                                    <a @click.prevent="tab = 'settings'; openPage()" href="#" :class="tab === 'settings' ? 'shadow inline-flex px-4 py-2 text-white bg-blue-600 rounded-lg active' : 'border border-gray-200 inline-flex px-4 py-2 rounded-lg hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-white'" aria-current="page">
                                        <svg class="w-4 h-4 mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                            ...
                            <div v-if="tab === 'statistics'">
                                <section>
                                    <div class="mx-auto text-center">
                                        <div class="bg-white border shadow border-gray-200 dark:border-gray-700 rounded-lg grid max-w-full mx-auto text-gray-900 lg:grid-cols-4 sm:grid-cols-3 dark:text-white">
                            ...
                            <div v-if="tab === 'settings'" class="grid grid-cols-5 gap-8">
                                <div class="col-span-2">
                                    ...
                                    <ul class="text-sm font-medium shadow text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                ...
                                <div class="col-span-3">
                                    <div>
                                        ...
                                        <div class="mb-5">
                                            <div>
                                                <span class="bg-white text-xs shadow font-semibold py-1 px-3 border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                                                    RUB
                                                </span>
                                            </div>
