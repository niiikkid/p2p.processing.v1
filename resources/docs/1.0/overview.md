...
- API предназначен для интеграции магазинов и прочих сервисов на которых вы захотите подключить оплату по p2p.

<a name="methods-api"></a>
## Методы API
...
- Уведомление содержит данные соответствующие данным которы возвращает метод **GET /api/merchant/order/{order_id}**.
