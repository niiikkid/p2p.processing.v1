...
const formSettings = useForm({
    make_order_amount_unique: !!merchant.value.make_order_amount_unique,
});
...
<template>
    <div class="gap-8 grid 2xl:grid-cols-7 xl:grid-cols-5">
        <div class="2xl:col-span-3 xl:col-span-2">
            ...
            <div v-if="viewStore.isAdminViewMode" class="my-8">
                <h3 class="text-xl font-medium text-gray-900 dark:text-white mb-3">Настройки администратора</h3>
                <div class="p-6 bg-white shadow border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
                    <form @submit.prevent="submitSettings">
                        <div>
                            <label class="inline-flex items-center mb-3 mt-3 cursor-pointer">
                                <input type="checkbox" value="" class="sr-only peer" v-model="formSettings.make_order_amount_unique" @change="submitSettings">
                        ...
                        <div class="flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
                            ...
                            <div>
                                Данная настройка будет применена только к тем методам, где отключено подтверждение по 4 цифрам карты.
                            </div>
                        </div>
                    </form>
                </div>
                        ...
                        >
                            <div class="flex justify-between items-center">
                                <div class="flex items-center gap-3">
                                    <img v-if="gateway.logo" :src="gateway.logo" class="h-8 w-8" :alt="gateway.name">
                                    <div>
                                        ...
                                        <div class="text-xs flex">
                                            <div class="flex items-center mr-2 text-gray-500 dark:text-gray-400">
                                                ...
                                                {{parseFloat(commissionSettings[gateway.id]['merchant_commission']).toFixed(1)}}%
                                            </div>
