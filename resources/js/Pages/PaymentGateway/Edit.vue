...
const paymentGatewaysForSBP = usePage().props.paymentGatewaysForSBP;
                ...
                <div class="p-4 sm:p-8 bg-white dark:bg-gray-800 shadow sm:rounded-lg">
                    <section class="max-w-xl">
                        ...
                        <form @submit.prevent="submit" class="mt-6 space-y-6">
                            ...
                            <div v-if="form.code === 'sbp'">
                                <DropDownWithCheckbox
                                    v-model="form.sub_payment_gateways"
                                    :items="paymentGatewaysForSBP"
                                    value="id"
                                    name="name"
                                    label="Методы"
                                />
                            ...
                            <div class="flex items-center p-4 mb-4 text-sm text-blue-800 border border-blue-300 rounded-lg bg-blue-50 dark:bg-gray-800 dark:text-blue-400 dark:border-blue-800" role="alert">
                                ...
                                <span class="sr-only">Инфо</span>
                                <div>
                                    Данная настройка немного увеличивает сумму сделки, чтобы сделать сумму уникальной, таким образом увеличить количество используемых реквизитов.
                                </div>
                            </div>
