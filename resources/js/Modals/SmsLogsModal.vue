            ...
            <div class="mx-auto space-y-6" v-if="smsLogs.data">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 border-separate border-spacing-y-3 rounded">
                    ...
                    >
                        <th
                            scope="row"
                            class="pl-3 pr-1 py-2 font-medium text-gray-900 whitespace-nowrap dark:text-gray-200 rounded-l-xl first:border-l last:border-r border-t border-b dark:border-gray-700"
                        >
                            <div>#{{ smsLog.id }}</div>
                        </th>
                        <td class="px-3 py-2 first:border-l last:border-r border-t border-b dark:border-gray-700">
                            <div class="flex text-nowrap dark:text-gray-200">
                                <svg class="w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
                                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 21a9 9 0 1 0 0-18 9 9 0 0 0 0 18Zm0 0a8.949 8.949 0 0 0 4.951-1.488A3.987 3.987 0 0 0 13 16h-2a3.987 3.987 0 0 0-3.951 3.512A8.948 8.948 0 0 0 12 21Zm3-11a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z"/>
                                </svg>
                                <span class="pl-1">{{ smsLog.sender }}</span>
                            </div>
                            <div class="flex text-nowrap dark:text-gray-500">
                        ...
                        <td class="px-3 py-2 rounded-r-xl first:border-l last:border-r border-t border-b dark:border-gray-700">
                            <div class="dark:text-gray-200">{{ smsLog.message }}</div>
                        </td>
                    </tr>
                    </tbody>
                </table>
