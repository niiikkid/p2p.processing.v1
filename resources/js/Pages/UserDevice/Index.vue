            ...
            <template v-slot:body>
                <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                    <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                        <template v-for="d in props.devices" :key="d.id">
                            <tr
                                class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 cursor-pointer hover:bg-gray-50/50 dark:hover:bg-gray-700/30"
                            ...
                            >
                                <td colspan="6" class="px-6 py-3">
                                    <div class="mb-1 text-xs text-gray-500 dark:text-gray-400">Пинги за последний час, шаг 10с</div>
                                    <div class="flex gap-[2px] flex-wrap">
                                        <div
                                            v-for="(v, i) in (d.ping_timeline || [])"
                                            :key="i"
                                            class="w-3 h-3 rounded-[2px]"
                                            :class="v === 1 ? 'bg-green-500 dark:bg-green-400' : 'bg-red-500 dark:bg-red-600'"
